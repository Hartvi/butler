...
if __name__ == "__main__":
    ...
    rgripperm = rgripper.as_matrix()
    # print(rgripper.as_matrix())
    ...
    # print("relative rotation from eulers: ", R.from_euler('xyz', rgripper.as_euler('xyz', degrees=True) - np.array([4.584, -1.095, -88.824]), degrees=True).as_matrix())
    ...
    adjusted_M = adjusted_object_to_gripper(r.as_matrix(), t, rgripperm, tgripper)
    # print(adjusted_M)
    # print(adjusted_M[:3,:3])
    adjusted_r = R.from_matrix(adjusted_M[:3,:3])
    print(adjusted_M)
